    ...
    <section class="container">
        ...
        <div class="product">
            ...
            <div class="product-buttons">
                <button data-product="<?php echo $jsonProduct; ?>" pid="<?php echo $prod['product_id']; ?>" onclick="addToCart(this)" class="add-to-cart-button">Add to Cart</button>
                <button data-product="<?php echo $jsonProduct; ?>" onclick="buyNow(this)" class="buy-now-button">Buy Now</button>
            </div>
            </div>
        </div>
        </div>
