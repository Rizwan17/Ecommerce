              ...
              foreach($products as $product){
                ?>
                    <tr>
                        ...
                        <td><img width="50" height="50" src="<?php echo loadImage($product['product_image']); ?>" /></td>
                        <td><?php echo $product['product_price']; ?></td>
                        <td><?php echo $product['product_qty']; ?></td>
                        <td><?php echo $product['product_cat']; ?></td>
                        <td><?php echo $product['product_brand']; ?></td>
                        <td><a data-toggle="modal" data-target="#edit_product_modal" class="btn btn-sm btn-info edit-product" pid="<?php echo $product['product_id']; ?>" style="color:#fff;"><i
                        class="fas fa-pencil-alt"></i></a>&nbsp;<a
                                pid="<?php echo $product['product_id']; ?>" class="btn btn-sm btn-danger delete-product" style="color:#fff;"><i
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <img class="img-fluid e_image_placeholder" width="50">
                            </div>
                        </div>
                        <input type="hidden" name="pid">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary submit-edit-product">Add Product</button>
                        </div>
                    </div>
...
<script src="<?php echo getJSScript('admin/product'); ?>"></script>
